  ...
  return (
    <div className="min-h-screen p-6 flex flex-col items-center">
      ...
      <input 
        ...
        className="border-2 px-4 py-2 rounded-md w-full md:w-1/2 border-mediumBlue/90 dark:bg-blue-950/50 dark:border-lightBlue dark:text-white mb-8"
                ...
                {filteredRequests.map((request, index) => (
                  ...
                  >
                    ...
                    <p className="text-sm text-gray-700 dark:text-gray-300">
                      <span className="font-medium">{t('leave_type_label')} :</span> {request.motif}
                    </p>
