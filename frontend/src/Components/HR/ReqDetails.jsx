...
export default function ReqDetails() {
  ...
  return (
    <div className='flex flex-col justify-center items-center mb-5'>
      ...
      {/* Employee Profile */}
      <div className="bg-white dark:bg-blue-950/50 rounded-2xl p-6 shadow-md border-2 dark:border-gray-400" data-aos="fade-up">
      ...
      {/* Leave Details */}
      <div className="bg-white dark:bg-blue-950/50 rounded-2xl p-6 shadow-md border-2 dark:border-gray-400" data-aos="fade-up" data-aos-delay="200">
        <h3 className="text-lg sm:text-xl font-bold text-mediumBlue dark:text-politeBlue mb-4 flex items-center gap-2">
          📝 {t('request_details')}
        </h3>
        <ul className="space-y-2 text-gray-700 dark:text-gray-300">
    ...
    <div className="max-w-5xl w-full px-6 mt-6 flex flex-col sm:flex-row gap-4">
      <div data-aos='fade-right' data-aos-delay='400' className='w-full sm:w-1/2'>
        {
      ...
      <div data-aos='fade-left' data-aos-delay='600' className='w-full sm:w-1/2'>
      {
